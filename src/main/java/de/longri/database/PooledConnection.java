...
class PooledConnection implements Connection {
    ...
    public PooledConnection(String url, Connection connection, ConnectionPool pool) {
        this.url = url;
    ...
    // Delegate all other methods of Connection to the wrapped instance
    @Override
    ...
    // For brevity, not all methods are delegated here.
    // In a complete implementation, all methods of the Connection interface must be delegated.
    // ...

    // Get the actual connection to close it when the pool is shut down
